...
- Step 1 - Data for forcasting has already been prepared and the two datatsets in csv file format can be downloaded here -  [Target](./media/Target.csv), [Related](./media/Related.csv)
