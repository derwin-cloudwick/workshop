...
For both methods, we need to create three output **'Datasets'** to write the data from the job. Best part of Amorphic is - these datasets will automatically write data to Redshift tables without any coding.   So, let's create three **Datasets.**
